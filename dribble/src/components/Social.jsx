...
const SeventhSection = () => {
  ...
  return (
    <div className="p-8 my-20">
      ...
      <div className="rounded-3xl bg-blue-50 mx-10 flex flex-col items-center justify-center gap-5 h-[800px] xl:h-[600px]">
        <AnimatePresence>
          {isVisible && (
            <motion.div
              className="text"
        ...
        <div className="hidden md:flex gap-12 mt-5 w-full justify-center">
          <div className="flex flex-col gap-y-4 items-center">
            ...
            <AnimatePresence>
              {isVisible && (
                ...
                >
                  <p className="max-w-[250px] text-sm text-center">
